...
const SCENES = {
  ...
  'andino-name':  BASE_STYLE + ' ' + CITY_BG + ' ' + ANDINO_P + ' Full body dramatic low angle. Dark smoke surrounds him. MPC runes pulsing red. Massive bold glitch typography ANDINO in deep crimson red positioned in UPPER THIRD of frame — above the character. Blood moon above. Andes silhouette. 9:16 ALL 120px safe margins.',
  'piero-name':   BASE_STYLE + ' ' + CITY_BG + ' ' + PIERO_P + ' Full body center frame. Gold energy corona forming above. Iron microphone raised. Massive bold glitch typography PIERO LA ROCCA in tarnished gold positioned in UPPER THIRD of frame — above the character. Stone walls crack. 9:16 ALL 120px safe margins.',
  'kinny-name':   BASE_STYLE + ' ' + CITY_BG + ' ' + KINNY_P + ' Mid-air frozen kick. Three shuriken orbiting. Teal energy blazing. Massive bold glitch typography IlKINNY in electric teal positioned in UPPER THIRD of frame — above the character. Speed lines everywhere. 9:16 ALL 120px safe margins.',
