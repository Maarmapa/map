...
const SCENES = {
  ...
  'piero-name':   BASE_STYLE + ' ' + CITY_BG + ' ' + PIERO_P + ' Full body center frame. Gold energy corona forming above. Iron microphone raised. Massive bold distressed glitch typography spelling exactly PIERO LA ROCCA — two words on two lines PIERO on top LA ROCCA below — in blood crimson red — same exact style font weight and glitch effect as SOUTHSIDE title card — positioned in UPPER THIRD of frame above character head. Stone walls crack. 9:16 ALL 120px safe margins.',
